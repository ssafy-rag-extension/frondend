    ...
    <div className="space-y-3">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button
          ...
          className={`flex items-center gap-2 rounded-lg border bg-white px-3 py-2 text-sm font-medium ${
            isNew || !selected
        ...
        <button
          ...
          className={`flex items-center gap-2 rounded-lg border px-3 py-2 text-sm font-medium ${
            draft && (isDirty || isNew)
              ? 'border-[var(--color-hebees)] text-[var(--color-hebees)] hover:bg-[var(--color-hebees)]/5'
              : 'cursor-not-allowed opacity-40'
          }`}
